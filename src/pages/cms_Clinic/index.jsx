...
const Clinic = () => {
  ...
  const exportPDF = (data) => {
    ...
    exportToPDF(data, columnsToFilter, columnsToPrint, 'Clinics');
  };
  ...
  const exportToCsv = (data) => {
    ...
    if (navigator.msSaveBlob) {
      // IE 10+
      navigator.msSaveBlob(blob, 'Clinics_data.csv');
    } else {
      ...
      if (link.download !== undefined) {
        ...
        link.setAttribute('download', 'Clinics_data.csv');
  ...
  return (
    <DefaultLayout>
      ...
      <ClinicTable setSortedDataIndex={setSortedData} searchTerm={searchTerm} />
    </DefaultLayout>
  );
};
