...
const ManagersTable = ({ searchTerm, setSortedDataIndex }) => {
  ...
  if (isManagersLoading) return <Loader />;
  if (isError) return <div>Error occurred while fetching managers.</div>;
  if (!sortedData?.length)
    return (
      <div>
        <center>
          <h4 className="font-semibold">No Managers Found!</h4>
        </center>
      </div>
    );
  return (
