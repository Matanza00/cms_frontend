...
const ManagersAddForm = () => {
  ...
  const [AddManager, { isLoading, isError, error }] = useAddManagerMutation();
  ...
  useEffect(() => {
    setFormValues({
      ...formValues,
      cnic: managerCnicUrl,
      license: managerLicenceUrl,
      medicalCertificate: managerMedicalCertificateUrl,
    });
  }, [managerCnicUrl, managerLicenceUrl, managerMedicalCertificateUrl]);
...
export default ManagersAddForm;
