        ...
        <div className="flex items-center justify-between px-4 py-2">
          <div className="dropdown inline-block relative">
            ...
            <select
              ...
              className="px-1 ml-2 text-sm border bg-slate-100 border-slate-500 rounded-sm dark:border-slate-600 dark:bg-boxdark dark:text-slate-300 transition duration-150 ease-in-out"
            >
          ...
          <div className="flex items-center space-x-2">
            <button
              ...
              className={`px-2 py-2 rounded-md ${
                page === 1
                  ? 'bg-slate-200 text-gray-600 cursor-not-allowed dark:bg-slate-600 dark:text-graydark transition duration-150 ease-in-out'
                  : 'bg-blue-500 text-white hover:bg-blue-600 focus:outline-none focus:bg-blue-600 transition duration-150 ease-in-out'
              }`}
            >
              <RxDoubleArrowLeft />
            </button>
